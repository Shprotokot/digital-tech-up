          ...
          <div className="text-white">
            ...
            <div className="flex flex-wrap gap-4">
              <Button 
                ...
                className="bg-white text-indigo-600 hover:bg-gray-100 px-8 py-6 text-xl hover:scale-105 hover:shadow-2xl transition-all duration-300"
              >
                Начать проект
              ...
              <Button 
                ...
                className="border-2 border-white text-white bg-transparent hover:bg-white hover:text-indigo-600 transition-all duration-300 px-8 py-6 text-xl hover:scale-105 hover:shadow-2xl"
              >
                Узнать больше
              </Button>
            </div>
            <div className="mt-12 grid grid-cols-3 gap-4">
              <div className="group relative bg-white/10 backdrop-blur-md rounded-2xl p-4 text-center hover:bg-white/15 transition-all duration-500 border border-white/30 hover:border-white/50 shadow-lg hover:shadow-2xl">
                ...
                <div className="relative">
                  ...
                  <div className="mb-1">
                    <div className="text-3xl font-extrabold bg-gradient-to-br from-yellow-200 via-pink-200 to-pink-100 bg-clip-text text-transparent">250+</div>
                  </div>
                  <div className="text-white font-bold text-sm">Проектов</div>
                </div>
              </div>
              <div className="group relative bg-white/10 backdrop-blur-md rounded-2xl p-4 text-center hover:bg-white/15 transition-all duration-500 border border-white/30 hover:border-white/50 shadow-lg hover:shadow-2xl">
                ...
                <div className="relative">
                  ...
                  <div className="mb-1">
                    <div className="text-3xl font-extrabold bg-gradient-to-br from-yellow-200 via-pink-200 to-pink-100 bg-clip-text text-transparent">98%</div>
                  </div>
                  <div className="text-white font-bold text-sm">Удержание</div>
                </div>
              </div>
              <div className="group relative bg-white/10 backdrop-blur-md rounded-2xl p-4 text-center hover:bg-white/15 transition-all duration-500 border border-white/30 hover:border-white/50 shadow-lg hover:shadow-2xl">
                ...
                <div className="relative">
                  ...
                  <div className="mb-1">
                    <div className="text-3xl font-extrabold bg-gradient-to-br from-yellow-200 via-pink-200 to-pink-100 bg-clip-text text-transparent">5 лет</div>
                  </div>
                  <div className="text-white font-bold text-sm">На рынке</div>
                </div>
              </div>
            </div>
          </div>
